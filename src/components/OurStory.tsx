...
const stories = [
  ...
  },
  {
    ...
    year: "2025",
    title: "Предложение",
    text: "Солнечным весенним утром на берегу тихого озера Иван опустился на колено. Слёзы радости, счастливый смех и одно маленькое слово «Да» — начало новой главы нашей истории.",
  },
];
